...
public class C1_3 : MonoBehaviour
{
    private float posX;
    private float posY;
    private float posZ;
    ...
    public void FiguraCentro(int cont) {
        if (Ocupado() <= (63.13 * 40 * 0.75)) {

            var b = Instantiate(Polx[cont], new Vector3(0f, 0f, 0f), Quaternion.identity);
